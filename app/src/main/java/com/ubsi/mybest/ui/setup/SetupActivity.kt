package com.ubsi.mybest.ui.setup
...
import com.ubsi.mybest.databinding.ActivitySetupBinding
import com.ubsi.mybest.ui.login.LoginActivity
...
class SetupActivity : AppCompatActivity() {
    ...
    private fun setupClickListeners() {
        ...
        binding.btnContinue.setOnClickListener {
            if (binding.cbUserAgreement.isChecked) {
                ...
                Toast.makeText(
                    this,
                    getString(com.ubsi.mybest.R.string.user_agreement_required),
                    Toast.LENGTH_SHORT
                ).show()
            }
        }
    ...
    private fun updateNotificationStatus(granted: Boolean) {
        if (granted) {
            binding.tvNotificationStatus.text = getString(com.ubsi.mybest.R.string.permission_granted)
            binding.tvNotificationStatus.setTextColor(ContextCompat.getColor(this, com.ubsi.mybest.R.color.status_success))
            binding.ivNotificationCheck.visibility = View.VISIBLE
        } else {
            binding.tvNotificationStatus.text = getString(com.ubsi.mybest.R.string.tap_to_enable)
            binding.tvNotificationStatus.setTextColor(ContextCompat.getColor(this, com.ubsi.mybest.R.color.primary))
    ...
    private fun updateExactAlarmStatus() {
        ...
        if (canScheduleAlarms) {
            binding.tvBackgroundStatus.text = getString(com.ubsi.mybest.R.string.permission_granted)
            binding.tvBackgroundStatus.setTextColor(ContextCompat.getColor(this, com.ubsi.mybest.R.color.status_success))
            binding.ivBackgroundCheck.visibility = View.VISIBLE
        } else {
            binding.tvBackgroundStatus.text = getString(com.ubsi.mybest.R.string.tap_to_enable)
            binding.tvBackgroundStatus.setTextColor(ContextCompat.getColor(this, com.ubsi.mybest.R.color.primary))
