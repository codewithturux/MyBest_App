package com.ubsi.mybest.ui.profil
...
import com.ubsi.mybest.databinding.FragmentProfilBinding
    ...
    private fun loadUserData() {
        viewLifecycleOwner.lifecycleScope.launch {
            ...
            if (user != null) {
                ...
                val email = prefManager.userEmail.ifEmpty { "guest@students.ubsi.ac.id" }
