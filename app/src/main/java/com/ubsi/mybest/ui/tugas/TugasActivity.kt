package com.ubsi.mybest.ui.tugas
...
import com.ubsi.mybest.databinding.ActivityTugasBinding
    ...
    private inner class TugasPagerAdapter(
        ...
        override fun createFragment(position: Int): Fragment {
            return when (position) {
                0 -> TugasEmptyFragment.newInstance(
                    getString(R.string.no_tugas),
                    getString(R.string.no_tugas_desc)
                )
